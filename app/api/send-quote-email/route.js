        ...
        <div style="font-family: Arial, sans-serif; padding: 24px; background: #ffffff; color: #111111;">
          <div style="max-width: 620px; margin: 0 auto; border: 1px solid #e5e5e5; border-radius: 12px; overflow: hidden;">
            ...
            <div style="padding: 24px;">
              ...
              <p style="font-size: 15px; line-height: 1.7; color: #333333;">
                Thanks for reaching out to The DTL Co. We’ve received your enquiry and will be in touch shortly to confirm details and provide a tailored quote.
              </p>
              ...
              <p style="margin-top: 12px; font-size: 15px; line-height: 1.7; color: #333333;">
                If there’s anything urgent, feel free to reply directly to this email.
              </p>
            </div>

            <div style="padding: 18px 24px; border-top: 1px solid #e5e5e5; background: #fafafa; color: #666666; font-size: 12px;">
